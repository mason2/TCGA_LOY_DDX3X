...
#Run T-Test
t.test(TCGA_expression_DDX3X_male[TCGA_expression_DDX3X_male$functional_YCN == "LOY", ]$DDX3X,
       TCGA_expression_DDX3X_male[TCGA_expression_DDX3X_male$functional_YCN == "WTY", ]$DDX3X)
```
...
#Remove Tissue Types with only WTY
TCGA_expression_DDX3X_male <- TCGA_expression_DDX3X_male[!TCGA_expression_DDX3X_male$acronym %in% c("BRCA", "GBM", "PRAD"), ]
